...
```
    ...
    <button
      ...
      className="w-full bg-purple-600 text-white p-4 rounded-2xl"
    >
      Send OTP
    </button>
...
```
  ...
  <input
    type="date"
    className="w-full p-4 rounded-2xl mt-4 border"
  />
  ...
  <button
    ...
    className="w-full bg-purple-600 text-white p-4 rounded-2xl mt-6"
  >
    Confirm Booking
  </button>
